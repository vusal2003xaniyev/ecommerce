...
(function ($) {
  ...
  $("#data-table, .data-table").DataTable({
    ...
    language: {
      lengthMenu: "Siyahıda göstərilən say : _MENU_",
      paginate: {
...
// Fonksiyonların çalışmasından önce yüklenme göstergesini gizle
function hideLoadingOverlay() {
    document.getElementById('loading-overlay').style.display = 'none';
}

// Fonksiyonların çalışmasından sonra yüklenme göstergesini göster
