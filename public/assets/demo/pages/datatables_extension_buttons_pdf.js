...
const DatatableButtonsPdf = (function () {
    ...
    const _componentDatatableButtonsPdf = function () {
        ...
        $.extend($.fn.dataTable.defaults, {
            ...
            language: {
                search: '<span class="me-3">Filtr:</span> <div class="form-control-feedback form-control-feedback-end flex-fill">_INPUT_<div class="form-control-feedback-icon"><i class="ph-magnifying-glass opacity-50"></i></div></div>',
                searchPlaceholder: "Filtr etmək üçün yazın...",
        ...
        $(".datatable-pdf-message").DataTable({
            buttons: {
                ...
                buttons: [
                    {
                        extend: "pdfHtml5",
                        text: 'PDF kimi yükləyin <i class="ph-file-pdf ms-2"></i>',
                        messageTop:
                            "This is a custom message added in configuration.",
                    },
                ],
            },
        });
